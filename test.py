...
# get_symbols(output_format='pandas', token="sk_33d0f37bacbb40aea6488085428bdee5")

logger = logging.getLogger(__name__)

# Google
# api = tradeapi.REST(
#     key_id='PKAHVHF33U6NTUM0HW6T',
#     secret_key='sUuRg0H1m5UiTEH2nORIG0lCD2iF8Gb3AGrYhO4e',
#     base_url='https://paper-api.alpaca.markets'
# )

# Yahoo
api = tradeapi.REST(
    key_id='PK37KUYT8ZJNHU6XQ0NH',
    secret_key='LWKB89FF6XArmf5WHHcGyo3x3uFp1OuSLN6mcTle',
    base_url='https://paper-api.alpaca.markets'
)
...
def get_stockdata(symbols):
    ...
    for i in range(0, len(symbols), partlen):
        ...
        kstats = Stock(part).get_key_stats()
        # print(kstats)
        previous = Stock(part).get_previous_day_prices()
        # print(previous)
